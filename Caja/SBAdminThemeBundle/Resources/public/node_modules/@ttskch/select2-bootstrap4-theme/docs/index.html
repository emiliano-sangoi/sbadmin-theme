...
<head>
  ...
  <!-- select2 -->
  <link rel="stylesheet" href="http://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.min.css">

  <!-- select2-bootstrap4-theme -->
  <link rel="stylesheet" href="http://cdn.jsdelivr.net/npm/@ttskch/select2-bootstrap4-theme/dist/select2-bootstrap4.min.css"> <!-- for live demo page -->
...
<script src="http://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.min.js"></script>
<!-- select2 -->
